...
def main():
	## Define file
	transcript_file = "/Users/nasrallah/Desktop/scotus_project/scotus_python/myriad.txt"

	## The eight speaking justices and the three (for this case) other speakers
	speakers = ['MR. HANSEN', 'MR. VERRILLI', 'MR. CASTANIAS', 'CHIEF JUSTICE ROBERTS', 'JUSTICE SCALIA', 'JUSTICE KENNEDY', 'JUSTICE GINSBURG', 'JUSTICE BREYER', 'JUSTICE ALITO', 'JUSTICE SOTOMAYOR', 'JUSTICE KAGAN']
	...
	outfile = '/Users/nasrallah/Desktop/myriad_words.txt'
	with open(outfile, 'w') as f:
		f.write('Word counts for Myriad Genetics\n')
		for w in words:
			f.write( w + ',' + ','.join([str(x) for x in words[w]]) + '\n' )


	outfile = '/Users/nasrallah/Desktop/myriad_cutoffs.txt'
	with open(outfile, 'w') as f:
		f.write('Cutoff counts for Myriad\n')
		for w in cutoffs:
