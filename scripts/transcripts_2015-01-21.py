...
def main():
    ...
    P_pet_wins = pd.DataFrame(np.reshape(p/(p+r), (3,3)), index = amicus_labels, columns = interrupt_labels)
    ...
    for docket in case_features:
        ...
        case_features[docket]['P(Pet_win|features)'] = prob
